...
export default function Contact() {
  ...
  return (
    <div className="my-10">
      <div className="text-white my-10 dark:text-black">
      ...
      <form ref={form} onSubmit={HandleSend}>
        <div className="flex flex-col md:flex-row text-white gap-2">
          <div className="cursor-pointer border-[1.5px] w-full my-2 px-5 py-5 dark:border-gray-300  border-gray-800">
            <input
              ...
              onChange={HandleData}
              required
              className="w-full appearance-none bg-transparent border-none outline-none dark:text-black text-white"
            />
          </div>
          ...
          <div className="cursor-pointer border-[1.5px] w-full my-2 px-5 py-5 dark:border-gray-300 border-gray-800">
            <input
              ...
              onChange={HandleData}
              required
              className="w-full outline-none dark:text-black text-white bg-transparent"
            />
          </div>
        </div>
        ...
        <div className="cursor-pointer border-[1.5px] w-full my-2 px-5 py-5 dark:border-gray-300 border-gray-800">
          <textarea
            ...
            onChange={HandleData}
            required
            className="h-40 w-full outline-none dark:text-black text-white bg-transparent"
          />
        </div>
