...
export default function View() {
  ...
  return (
    <div key={data.id} className="text-white dark:text-black my-20">
      ...
      <div
        className="blog-content  dark:text-black space-y-4"
        dangerouslySetInnerHTML={{ __html: data.description }}
      ></div>

      <div className="text-white dark:text-black my-5">Tags</div>
